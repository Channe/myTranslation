...
---
> 原文链接：[Swift 2.0: Protocol-Oriented MVVM](http://natashatherobot.com/swift-2-0-protocol-oriented-mvvm/)
> 原文日期: 2015/08/17

> 译者：[小铁匠Linus](http://weibo.com/linusling)
> 校对：[Channe](http://www.jianshu.com/users/7a07113a6597/latest_articles)
> 审核：
...
一个拥有`label`和`switch`按钮的`cell`是很通用的。你可以把相同的 `cell` 运用在不同的地方，比如放在登录节目的 Remember Me 设置中。因此，你想让这个视图通用化。
